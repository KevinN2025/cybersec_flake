      ...
      in
      {
        devShells.default = pkgs.mkShell {
          buildInputs = with pkgs; [
              ...
              shorewall shadow waf wafw00f honeytrap crowdsec snort suricata bettercap
              python313Packages.dpkt haskellPackages.nemesis yas zeek rustscan
              python313Packages.angr detect-it-easy capstone scilla commix]
          ];
        };
      }
    );
